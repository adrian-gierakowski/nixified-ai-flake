# Relicensing Contributions from AGPL to MIT

We are seeking approval from all significant contributors to re-license the contributions in this repository from the GNU Affero General Public License (AGPL) to the MIT License. This change is intended to enable broader adoption and compatibility with other projects.
...
If you are listed above, please reply to this issue with the following text:

> I approve re-licensing my contributions to this project under the MIT license.

If you are unable to comment on this issue, please contact the maintainers directly.
